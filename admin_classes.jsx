...
const AdminPanel = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      const staff = await tryFetchJson(['/staffs.json', './staffs.json']);
      setStaffData(staff);
      const students = await tryFetchJson(['/students.json', './students.json']);
                ...
                <div className="flex-1">
                  ...
                  <div className="items-col">
                    {Array.isArray(staffData[dept.id]) && staffData[dept.id].length > 0 ? (
                      ...
                      <span className="item-name">Loading staff data...</span>
                    )}
                  </div>
                </div>
              </div>
                        ...
                        <div key={sectionIndex}>
                          ...
                          <div className="items-col">
                            {Array.isArray(sectionList) && sectionList.length > 0 ? (
                              ...
                              <span className="item-name">Loading students...</span>
                            )}
                          </div>
                        </div>
                      );
